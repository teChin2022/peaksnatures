-- Add booking_source column to track where the booking originated
-- Values: 'guest' (default, via website), 'booking_com', 'agoda', 'airbnb', 'trip_com', 'walk_in', 'phone', 'other'
ALTER TABLE bookings ADD COLUMN IF NOT EXISTS booking_source TEXT DEFAULT 'guest';

-- Update the create_booking_atomic function to accept booking_source
...
BEGIN
  ...
  -- Clean up booking holds for session
