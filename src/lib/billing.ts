...
import { getEffectiveCommissionPct } from "@/lib/billing-calc";
...
// Same arrangement for the pricing arithmetic: the admin "Set Plan" dialog and
// the host's term picker quote a term from the browser, so the formulas live in
// an import-free module and are re-exported here for server callers.
export {
