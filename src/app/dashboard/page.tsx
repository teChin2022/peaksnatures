...
export default function DashboardPage() {
  ...
  const demandLabels: DemandPanelLabels = useMemo(
    () => ({
      title: t("demandTitle"),
      subtitle: t("demandSubtitle"),
      funnelTitle: t("demandFunnelTitle"),
      topDatesTitle: t("demandTopDatesTitle"),
      topDatesHint: t("demandTopDatesHint"),
      stages: {
        page_view: t("demandStagePageView"),
        calendar_view: t("demandStageCalendarView"),
        dates_selected: t("demandStageDatesSelected"),
        step_dates: t("demandStageStep1"),
        step_details: t("demandStageStep2"),
        step_payment: t("demandStageStep3"),
        slip_uploaded: t("demandStageSlip"),
        booking_submitted: t("demandStageDone"),
      },
      sessions: t("demandSessions"),
      conversion: t("demandConversion"),
      lostDemand: t("demandLost"),
      soldOutSuffix: t("demandSoldOut"),
      empty: t("demandEmpty"),
      ranges: { d7: t("demandRange7"), d30: t("demandRange30"), d90: t("demandRange90") },
    }),
    [t],
  );
        ...
        <div className="space-y-6">
          ...
          {tab === "overview" ? (
            ...
            >
              ...
              {/* Guest demand — funnel + most-wanted dates, above the booking list
                  because it explains the bookings that did NOT happen. */}
              <DemandPanel endpoint="/api/host/demand" labels={demandLabels} locale={locale} />
